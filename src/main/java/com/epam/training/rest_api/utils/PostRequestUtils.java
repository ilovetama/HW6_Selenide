package com.epam.training.rest_api.utils;
...
public final class PostRequestUtils {
  ...
  public static ResponseBody makeRequestAndGetResponseBodyJson(String endpoint,
  ...
  public static ResponseBody makeRequestWithBodyAndGetResponseBodyJson(String request,
